  ...
  async function SIWG(key) {
    try {
      ...
      if (error.code === "auth/account-exists-with-different-credential") {
        ...
        // Retrieve existing sign-in methods for the email
        const existingMethods = await fetchSignInMethodsForEmail(auth, email);

        // Prompt the user to sign in with the same existing provider
        const existingProvider = new GoogleAuthProvider(); // Replace with the appropriate existing provider
        await signInWithPopup(auth, existingProvider);

        // Link the new provider's credentials with the existing account
      ...
      >
        ...
        <div class="flex-1 bg-indigo-100 text-center hidden lg:flex">
          <div
            ...
            style={{ backgroundImage: "url('https://firebasestorage.googleapis.com/v0/b/notes-5bb98.appspot.com/o/To%20do%20list-pana.png?alt=media&token=34dd29a0-c7b6-45b6-9ee0-048408dd9055')" }}
          ></div>
        </div>
      </div>
