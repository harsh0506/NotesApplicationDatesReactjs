                        ...
                        <div style={{ width: "40vw" }}>
                            ...
                            <div class="w-full pl-1 flex justify-between text-center items-center">
                                {getWeekDates().map((date) => (
                                    <span onClick={(e) => console.log(date)} key={date} class="h-7 w-7 rounded-full cursor-pointer transition-all hover:bg-[#fe0] hover:text-black bg-white flex justify-center items-center"><p style={{ color: "black" }}>{new Date(date).getDate()}</p></span>
